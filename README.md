...
- Procedural resource field: deterministic, four-quadrant coverage for trees, stone outcrops, ore seams, herbs, and daily-regrowing fishing spots. Resource positions derive from village seed and avoid building footprints; work labels and saved clear/regrowth state now include fishing.
...
- Cached world rendering with verified steady-state performance above the 45 FPS acceptance threshold on the development host; the native-v0.16.0 Hearth Pantry/interior/resource slice measured 145 FPS under headless rendering.
