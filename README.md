...
The native slice currently includes the deterministic 240×160 world, cached layered procedural terrain, narrower curved footpaths with shoulders and wear, authored cottage/hall/workshop/garden/barn structures, landmark silhouettes, continuous collision-safe movement, click-to-move pathfinding, click-to-approach building interaction, camera tracking, a fullscreen-first welcome/loading flow, pause-menu save/load, persistent display options, a readable 75% starting view with 50%–200% zoom, save schema v6, v5 coordinate migration, and rendered steady-state/input/UI smoke tests. It is an engineering vertical slice, not yet the complete Hobbit Moon game loop.
